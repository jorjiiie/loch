...
/*
  ...
  attempt to interpret the words as Loch values
...
/*
  ...
  much like the naive approach above, but try to have it print out values as Loch values
...
/*
  ...
  Arguments:
    Loch_val_addr: the *address* of some Loch value, which contains a Loch value, 
                     i.e. a tagged word.  
...
/*
  ...
  Arguments:
    bottom_frame: the base pointer of our_code_starts_here, i.e. the bottommost Loch frame
    top_frame: the base pointer of the topmost Loch stack frame
